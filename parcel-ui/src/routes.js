...
const NewParcel = React.lazy(() => import('./views/components/NewParcel'))
const BikerParcels = React.lazy(() => import('./views/components/BikerParcels'))
const SenderParcels = React.lazy(() => import('./views/components/SenderParcels'))
const ParcelView = React.lazy(() => import('./views/components/ParcelView'))
const PickupParcel = React.lazy(() => import('./views/components/PickupParcel'))
const DeliverParcel = React.lazy(() => import('./views/components/DeliverParcel'))
...
const routes = [
  ...
  { path: '/new-parcel', name: 'New Parcel', component: NewParcel },
  { path: '/sender-parcels', name: 'Parcels', component: SenderParcels },
  { path: '/biker-parcels', name: 'Parcels', component: BikerParcels },
  { path: '/parcel-view/:id', name: 'ParcelView', component: ParcelView},
  { path: '/parcel-pickup/:id', name: 'PickupParcel', component: PickupParcel},
  { path: '/parcel-deliver/:id', name: 'DeliverParcel', component: DeliverParcel}
]
